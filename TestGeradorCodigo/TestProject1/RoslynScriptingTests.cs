...
public class Executor { 
    ...
    public int GetJsonFromAlbumViewer(int id)
    {
        ...
        return 10;
            ...
            dynamic instance = assembly.CreateInstance("ScriptExecution.Executor");

            var json = instance.GetJsonFromAlbumViewer(37);
...
";
            ...
            try
            {
                var model = new ScriptTest { Message = "Hello World", Name = "Rick" };
